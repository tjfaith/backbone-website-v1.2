    ...
    <div className="page-max-width ">
      ...
      >
        ...
        <div className="relative z-10 pointer-events-none flex flex-col justify-end h-full p-10 bg-black/30">
          ...
          <div className="xl:text-lg text-sm text-white max-w-xl font-medium tracking-tight">
            Our Mission is to enable at least half fiat transactions that either
            originate out of Africa, have their destination in Africa, or are in
            one way or the other connected to Africa and Africans.
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="relative z-10 pointer-events-none flex flex-col justify-end h-full p-10">
            <div className="text-3xl text-white mb-2 clash-display-font">
              Vision
            </div>
            <div className="xl:text-lg text-sm text-white max-w-xl font-medium tracking-tight">
