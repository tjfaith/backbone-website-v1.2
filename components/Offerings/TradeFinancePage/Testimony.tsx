...
//   return (
//     <div className=" py-14">
//       <div className="page-max-width mx-auto flex items-center justify-center w-full">
//         {cardPros.map((data, index) => (
//           <TestimonyCard
//             imageClassName={`${index === 0 && "object-[50%_50%]"}`}
//             className={`${(index < 1 || index > 1) && "h-[382px]"} ${index === 0 && "-mr-9"} ${index === 2 && "-ml-8 z-10"} ${index === 1 && "z-20"}`}
//             key={index}
//             cardPros={data}
//           />
//         ))}
