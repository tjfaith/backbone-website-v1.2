    ...
    <div className="pt-12 pb-14">
      <div className="page-max-width">
        <div className="relative">
          <Image
            removeWrapper
            className="h-[360px] sm:h-[420px] lg:h-[460px] w-full object-cover object-[50%_50%]"
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center text-white justify-center">
            ...
            >
              <GetStartedBtn
                className="text-base text-primary bg-white dark:bg-foreground-50 dark:text-background"
                label="Start investing"
              />
              <ContactSalesBtn
                className="text-white bg-transparent dark:text-foreground-50"
