  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center page-max-width">
        <div className="animate__delay-2s animate__animated animate__fadeInUp animate__fast md:bg-background-100 shadow-[inset_0px_-1px_4px_0px_rgba(0,0,0,0.06)]  text-white  md:text-primary rounded-full p-[6px] inline-flex md:flex-row flex-col items-center justify-center md:justify-start gap-3 mb-4">
        ...
        <div className=" text-2xl   sm:text-5xl font-medium clash-display-font mb-5 space-y-1 text-primary space-y-3">
