  ...
  return (
    <div className=" rounded-2xl bg-background md:px-12 px-3 py-3 md:py-12 xl:py-3 mt-16 flex lg:flex-row flex-col items-center justify-between  space-y-5">
      <div data-aos="fade-up">
        ...
        <div className="clash-display-font lg:text-4xl md:text-3xl text-2xl text-primary font-medium lg:max-w-sm mb-1 md:text-start text-center">
          Send money locally and internationally
        </div>
        <div className="text-primary-400 text-base font-medium lg:max-w-xs tracking-tight md:text-start text-center">
