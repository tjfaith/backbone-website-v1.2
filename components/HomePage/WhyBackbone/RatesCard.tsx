...
const RatesCard = () => {
  return (
    <div
      className="border-b-[0.5px] border-foreground-100 dark:border-foreground-700 flex flex-col justify-between items-center w-full px-6 sm:px-10 lg:px-14 py-7"
      data-aos="fade-up"
    >
      {/* ICON STACK */}
      <div className="grid grid-cols-3 gap-2 sm:gap-4 items-end w-full max-w-md mx-auto lg:max-w-none">
        {/* LEFT */}
        <div className="bg-gradient-to-t rounded-t-[18px] from-background-200/20 via-foreground-100/20 to-[#CACFD8]/20 dark:from-background dark:via-foreground-700 dark:to-foreground-600/20 p-[6px]">
          <div className="bg-foreground-100 dark:bg-background-700 p-1 rounded-[18px]">
            <div className="rounded-full bg-[#CACFD8] dark:bg-foreground-600 p-2 inline-flex items-center justify-center text-white">
              <Icon className="text-xl" icon="ri:building-2-fill" />
            </div>
          </div>
          <Spacer className="lg:!h-[28px]" y={20} />
        ...
        <div>
          <div className="w-full flex justify-center">
            <div className="relative px-3 mx-auto py-1 inline-flex rounded-full flex-col items-center text-center text-info-250 dark:text-info-200 bg-[#EBF8FF] dark:bg-info-950 mb-3 sm:mb-4 lg:mb-5">
              <Icon
                className="absolute -bottom-2 sm:-bottom-3 left-1/2 -translate-x-1/2 rotate-180 text-[#EBF8FF] dark:text-info-950"
                icon="mingcute:triangle-fill"
              />
              <div className="rounded-full h-3.5 w-3.5 bg-white dark:bg-background-800 absolute -bottom-5 sm:-bottom-6 left-1/2 -translate-x-1/2 flex items-center justify-center">
                <div className="bg-info-250 rounded-full h-2 w-2" />
              </div>
              <div className="bg-[#EBF8FF] dark:bg-info-950 text-info-250 dark:text-info-200 rounded-lg text-sm whitespace-nowrap">
                Better rates
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-t rounded-t-[18px] from-[#EBF8FF]/10 via-[#C0EAFF]/20 to-info-250/20 dark:from-background dark:via-info-900/30 dark:to-info-700/30 p-[6px]">
            <div className="bg-[#C0EAFF] dark:bg-info-900 p-1 rounded-[18px]">
              <div className="rounded-full bg-info-250 dark:bg-info-700 p-2 inline-flex items-center justify-center">
                <Image
                  disableAnimation
                  disableSkeleton
                  alt="half logo black"
