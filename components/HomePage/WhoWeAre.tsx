  ...
  return (
    <div className="max-w-screen-2xl mx-auto lg:px-28 px-6 pt-60 pb-10 md:pt-0  md:py-10 ">
      <div className=" flex flex-col items-center justify-center mb-6">
        ...
        <div className="text-foreground text-lg font-normal md:max-w-3xl text-center">
      ...
      <div className=" grid md:grid-cols-2  gap-6 ">
        ...
        <div
          className=" border rounded-xl bg-background-100 shadow-sm border-foreground-300 inline-flex flex-col"
          data-aos="fade-up"
        >
          <div className=" p-4 mb-16">
            <div className="clash-display-font text-foreground-950 text-3xl font-medium">
