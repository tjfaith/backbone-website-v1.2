...
const Partners = () => {
    return (
        <div
            className="max-w-screen-2xl mx-auto lg:px-28 px-6 py-16 grid md:grid-cols-2 gap-10 "
        ...
        >
            <div className="">
                ...
                <div className="text-foreground-950 text-2xl  xl:text-5xl font-medium leading-tight max-w-2xl clash-display-font" id="get_started">
