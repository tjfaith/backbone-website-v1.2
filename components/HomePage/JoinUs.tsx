...
const JoinUs = () => {
  ...
  const components = {
    individuals: {
      component: <JoinUsIndividual />,
      color: "bg-info-250 dark:bg-info-200",
    },
    businesses: {
      component: <JoinUsBusinesses />,
            ...
            <Tabs
              ...
              classNames={{
                ...
                tabContent: `text-white dark:text-foreground-50 w-full text-sm font-medium rounded-full px-4 py-2 ${
                  selectedTab === "individuals"
                    ? "group-data-[selected=true]:text-info-300 group-data-[selected=true]:bg-white dark:group-data-[selected=true]:bg-background-100"
                    : selectedTab === "businesses" &&
